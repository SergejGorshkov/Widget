"""
Модуль 'masks' предназначен для получения от пользователя номера банковской карты
(например: 3232 3232 4545 6565) и номера счета (например: 90903209302935646897) и
