...
@pytest.fixture
def right_data_for_processing_filter_by_state():
    return [
...
@pytest.fixture
def right_data_for_processing_sort_by_date():
    return [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
...
# Исходные данные о транзакциях для проверки работы функций filter_by_currency, transaction_descriptions в модуле
# generators.py
@pytest.fixture
def transactions_data_for_generators():
    return (
    [
        {
            "id": 939719570,
